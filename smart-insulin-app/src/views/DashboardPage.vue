      ...
      <div class="page-wrapper">
        <div class="dashboard-layout">
          ...
          <div class="dashboard-left">
            ...
            <ion-card>
              <ion-card-header>
                <ion-card-title>{{ t('dashboard.hba1c.title') }}</ion-card-title>
            ...
            <ion-card>
              <ion-card-header>
                <ion-card-title>{{ t('dashboard.addReading.title') }}</ion-card-title>
              </ion-card-header>
              <ion-card-content>
                <ion-list lines="none">
                  <ion-item>
          ...
          <div class="dashboard-right">
            <ion-card class="readings-card">
              <ion-card-header>
                <ion-card-title>{{ t('dashboard.recentReadings.title') }}</ion-card-title>
              </ion-card-header>
              <ion-card-content>
...
import {
  ...
  IonLabel, IonInput, IonSelect, IonSelectOption, IonButton, IonIcon, IonSpinner,
  toastController,
} from '@ionic/vue';
...
onMounted(() => { loadReadings(0); loadHbA1c(); });
</script>

<style scoped>
.hba1c-display { text-align: center; }
...
@media (min-width: 768px) {
  ...
  .dashboard-left { flex: 0 0 42%; }
  .dashboard-right { flex: 1; }
  .readings-card { position: sticky; top: 8px; }
}
</style>
